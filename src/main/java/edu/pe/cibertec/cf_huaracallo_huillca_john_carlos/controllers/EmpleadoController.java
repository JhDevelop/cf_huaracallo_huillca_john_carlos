package edu.pe.cibertec.cf_huaracallo_huillca_john_carlos.controllers;
...
import edu.pe.cibertec.cf_huaracallo_huillca_john_carlos.services.IEmpleadoService;
...
public class EmpleadoController {
    ...
    public ResponseEntity<Empleado> save(@RequestBody Empleado empleado){
        return new ResponseEntity<>(empleadoService.save(empleado), org.springframework.http.HttpStatus.CREATED);
    }
    ...
    /**public ResponseEntity<byte[]> generatePDF() {
        try {
            ...
            JasperPrint jasperPrint = JasperFillManager.fillReport("src/main/resources/reports/Blank_A4.jasper",parameters,dataSource);
            byte[] reporte = JasperExportManager.exportReportToPdf(jasperPrint);
            HttpHeaders headers = new HttpHeaders();
            headers.setContentType(MediaType.APPLICATION_PDF);
            headers.setContentDispositionFormData("inline","ReporteEmpleados");
